        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-white rounded-lg shadow-md p-8 animate-slide-right">
            ...
            <form>
              ...
              <div className="mb-4">
                <label htmlFor="subject" className="block text-spruce font-medium mb-1">
                  Subject
                </label>
                <input 
                  type="text" 
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-cream">sales@spruceandsettle.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-cream">15 Victoria Island Boulevard, Lagos, Nigeria</p>
                    <p className="text-neutral-cream">42 Waterfront Drive, Cape Town, South Africa</p>
                    <p className="text-neutral-cream">78 Sandton Avenue, Johannesburg, South Africa</p>
                  </div>
                </div>
              </div>
            </div>
            
            <div className="bg-white rounded-lg shadow-md overflow-hidden flex-1 animate-slide-up" style={{animationDelay: '0.2s'}}>
              <iframe 
