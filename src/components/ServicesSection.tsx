...
const getIcon = (iconName: string) => {
  switch (iconName) {
    case 'home': return <Home size={24} className="text-gold" />;
    case 'key': return <Key size={24} className="text-gold" />;
    case 'trending-up': return <TrendingUp size={24} className="text-gold" />;
    case 'building': return <Building size={24} className="text-gold" />;
    case 'map-pin': return <MapPin size={24} className="text-gold" />;
    case 'layout': return <Layout size={24} className="text-gold" />;
    default: return <Home size={24} className="text-gold" />;
  }
};
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="max-w-2xl mx-auto text-neutral-cream">
            We offer a comprehensive range of real estate services tailored to meet the needs of our discerning clients.
          </p>
        </div>
